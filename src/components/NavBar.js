...
<AppBar  position="static">
      <Container className='app'maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Typography     variant="h6"noWrapcomponent="a"  href="/"
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            <Menu id="menu-appbar" anchorOrigin={{vertical: 'bottom', horizontal: 'left' }} keepMounted transformOrigin={{ vertical: 'top', horizontal: 'left', }} sx={{display: { xs: 'block', md: 'none' },}}>
              {pages.map((page) => (
                <MenuItem  >
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>{pages.map((page) => (
           ...
           <Box sx={{ flexGrow: 0 }}>
            ...
            <Menu sx={{ mt: '45px' }}id="menu-appbar" anchorOrigin={{ vertical: 'top', horizontal: 'right' }} keepMounted transformOrigin={{   vertical: 'top', horizontal: 'right',}}>
              <HomeIcon />
